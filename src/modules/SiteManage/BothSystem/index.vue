        ...
        <ListAutoLayout>
            ...
            <CheckList ref="listCheck" :data="data" :blnSel="blnSel" id="id" @change="selChange">
                ...
                <template slot="body" slot-scope="{d}">
                    <v-table-column :title="d.abnormalDtNote"><span class="clickItem" @click="IssueDetail(d)">{{d.abnormalDtNote}}</span></v-table-column>
...
import {Export,DualSystemExport} from '@/store/Export/types.js'
...
.BothSystem{width:100%;height:100%;box-sizing:border-box;text-align:left;}
</style>