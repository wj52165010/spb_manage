...
(function () {
    var dr=function (func, context, delaytime) {
  ...
  var e = BMapLib.MarkerClusterer = function (l, h) {
    ...
    this._markers = [];
    this._clusters = [];
    this.mouseover=h.mouseover || function(){};
    this.mouseout=h.mouseout || function(){};
    var k = h || {};
  ...
  g.prototype.updateClusterMarker = function () {
    ...
    if(this.blnAddListen){return;}
    this.blnAddListen=true;
    this._clusterMarker.addEventListener("click",hander);
    this._clusterMarker.addEventListener("mouseover",function(){s._markerClusterer.mouseover(s._markers,s._center)});
    this._clusterMarker.addEventListener("mouseout",function(){s._markerClusterer.mouseout(s._markers,s._center)});
  };
